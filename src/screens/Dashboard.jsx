...
function Dashboard() {
  return (
    <div className="grid overflow-hidden grid-cols-6 grid-rows-12 gap-2 w-screen h-screen">
    <div className="box row-start-1 row-span-1 col-start-1 col-span-6"><Navbar /></div>
    <div className="box row-start-2 row-span-3 col-start-1 col-span-1">2</div>
    <div className="box row-start-2 row-span-3 col-start-2 col-span-1">3</div>
